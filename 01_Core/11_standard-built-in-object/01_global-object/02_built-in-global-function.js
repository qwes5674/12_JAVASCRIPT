...
// encodeURI
// URI(인터넷에 있는 자원을 나타내는 유일한 주소) 문자열로 전달받아 이스케이프 처리를 위해 인코딩한다.
// queryString , get 요청할때
const uri = 'http://ohgiraffers.com?name=홍길동&job=student';
const enc = encodeURI(uri);
console.log(enc); //http://ohgiraffers.com?name=%ED%99%8D%EA%B8%B8%EB%8F%99&job=student

// decodeURI
// 인코딩 된 URI를 인수로 받아, 이스켕프 처리 이전으로 디코딩
const dec = decodeURI(enc);
console.log(dec); // http://ohgiraffers.com?name=홍길동&job=student
