...
const idol1 = ['아이브','오마이걸']; //idol1 기준으로 합쳐짐
const idol2 = ['트와이스','레드벨벳']; // idol3 기준으로 합쳐짐
const idol3 = ['블랙핑크','에스파'];

// 배열명.concat(배열명1, 배열명2, ...)
const mix = idol1.concat(idol2); //idl
...
console.log('--------------slice--------------');
// Array.prototy.slice : 배열의 요소 선택 잘라내기
...
console.log('--------------reverse--------------');
// Array.prototype.reverse : 배열의 순섯를 뒤집음
