...
// 화살표함수는 항상 익명함수로 정의된다. 본문이 한줄인 함수를 작성할 때 유용
...
// 명령문이 하나만 있을 떄, 중괄호도 생략가능
// 이때 함수 몸체 내부의 문이 값으로 평가될 수 있는 표현식이면
// 암묵적으로 반환되기 떄문에 return도 생략가능
message = () => "화살표 함수"
...
// 객체 리터럴을 반환 할 때 함수 몸체부분을 소괄호로 감싸주어야 한다.
...
// 객체로 인식해야 하는 중괄호를 함수 몸체 중괄호로 잘못 인식한다.
